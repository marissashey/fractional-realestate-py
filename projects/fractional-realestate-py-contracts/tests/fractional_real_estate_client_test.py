...
def test_says_hello(fractional_real_estate_client: FractionalRealEstateClient) -> None:
    result = fractional_real_estate_client.send.hello(args=("World",))
...
def test_simulate_says_hello_with_correct_budget_consumed(
    ...
    result = (
        fractional_real_estate_client.new_group()
        .hello(args=("World",))
        .hello(args=("Jane",))
        .simulate()
    )
